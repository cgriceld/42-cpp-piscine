...
{
	_hit_points ? std::cout << yellow << "FR4G-TP " << _name << " attacks " << target << " at range, causing " <<_ranged_attack << " points of damage! *furious beep*\n" : \
...
{
	_hit_points ? std::cout << yellow << "FR4G-TP " << _name << " attacks " << target << " at melee, causing " <<_melee_attack << " points of damage! *furious beep*\n" : \
	std::cout << red << "FR4G-TP " << _name << " is powerless because it's damaged, needs repair... *broken beep*";
	std::cout << cancel << std::endl;
}
